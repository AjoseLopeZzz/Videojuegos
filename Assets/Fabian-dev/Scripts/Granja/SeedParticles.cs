...
public class SeedParticles : MonoBehaviour
{
    ...
    private void OnParticleCollision(GameObject other)
    {
       ...
       // ParticleCollisionEvent[] collisionEventsArray = new ParticleCollisionEvent[50];
        List<ParticleCollisionEvent> collisionEvents = new List<ParticleCollisionEvent>(50);
